      ...
      <div className="card mt-6 overflow-x-auto p-5">
        ...
        <div className="overflow-x-auto">
          <div className="min-w-160 space-y-3">
            <div className="grid grid-cols-[1.4fr_0.9fr_0.9fr_1.1fr_0.9fr_0.7fr] gap-4 px-4 py-3 text-xs uppercase text-muted">
            ...
            {Array.from({ length: 5 }).map((_, rowIndex) => (
              <div
                key={rowIndex}
                className="grid grid-cols-[1.4fr_0.9fr_0.9fr_1.1fr_0.9fr_0.7fr] gap-4 rounded-xl border border-border bg-surface-2 px-4 py-4"
              >
