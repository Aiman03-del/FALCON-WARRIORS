      ...
      <section className="grid min-h-screen lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="relative hidden overflow-hidden lg:flex lg:flex-col lg:justify-between lg:p-10">
          <div
            ...
            aria-hidden="true"
          />
          {/* Site-theme gradient overlay for legibility */}
          <div
          ...
          >
            ...
            />
            <span className="font-display uppercase tracking-[0.14em]">Falcon Warriors</span>
          </Link>
        ...
        <div className="flex items-center justify-center bg-background px-5 py-10 sm:px-8">
          <div className="w-full max-w-sm">
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-surface px-4 py-3 text-sm font-medium text-white transition hover:border-gold/40 hover:bg-surface-2 focus:outline-none focus:ring-2 focus:ring-gold/20"
            >
